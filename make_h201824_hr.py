...
#
# high res run: down to 768**3 (gas) and 1152**3 (dark) in 25Mpc
#
...
def main():
    ...
    # mysystem('export OMP_NUM_THREADS=4; invfftr < hrb.fft0 > hrb.rg')
    ...
    # mysystem('speczero 0 %g < hrb.rfft > hrz.fft'
    ...
    mysystem('pmovefrgbg2nc %s.g7.bin base.fx base.fy base.fz hrb.fx hrb.fy hrb.fz %g %g %g %g %g %g %g %g %s.sbin'
    ...
    mysystem('scalenc %g %g %s.sbin %s.tbin' % (pboxsize, tscale, name, name))
